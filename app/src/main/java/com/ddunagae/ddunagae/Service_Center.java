...
public class Service_Center extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ServiceCenterRecyclerViewAdapter());
    ...
    class ServiceCenterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
            ...
            return new ServiceCenterActivityViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holder, int position) {
            ServiceCenterActivityViewHolder serviceCenterActivityViewHolder = ((ServiceCenterActivityViewHolder)holder);
